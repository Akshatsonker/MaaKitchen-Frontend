...
// import Chatbot from "../../../src/chatbot/chatbot.jsx";
...
export default function Footer() {
    ...
    return (
        <footer className="w-full bg-gradient-to-br from-gray-900 to-black text-white pt-12 pb-6 relative">
            ...
            {/* Chatbot Floating Button (Optional Toggle) */}
            {/* Uncomment if you want toggle logic */}
            {/* <button 
                onClick={toggleChatbot} 
                className="fixed bottom-6 right-6 bg-red-500 hover:bg-red-600 text-white p-3 rounded-full shadow-lg z-50"
            >
                {showChatbot ? <FiX /> : <FiMessageCircle />}
            </button> */}
